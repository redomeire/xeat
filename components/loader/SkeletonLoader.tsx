...
const PageLoader = () => {
    return (
        <div className="w-full absolute z-50 min-h-screen bg-white/70 flex items-center justify-center">
            <Head>
                <title>Loading</title>
            </Head>
...
export { SkeletonLoader, InstagramLoader, FacebookLoader, PageLoader };